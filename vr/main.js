...
const selectedCharacter = new URLSearchParams(location.search).get('character') || "D'Artagnan";
const chapterScene = Number(new URLSearchParams(location.search).get('scene') || 0);
...
const field = new THREE.Mesh(
  ...
  new THREE.MeshStandardMaterial({ color: 0x4c7a3a, roughness: 1 })
);
